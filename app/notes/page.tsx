...
export const metadata: Metadata = {
  title: 'Notes - Dewey',
  description: 'Course notes and curriculum materials for the Dewey learning series from Bear Brown & Company.',
}
  ...
  return (
    <div className="container px-4 md:px-6 mx-auto py-12">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-4xl font-bold tracking-tighter mb-4">Dewey: Notes</h1>
