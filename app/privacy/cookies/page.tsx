...
export const metadata: Metadata = {
  title: 'Cookie Policy - Dewey',
  description: 'Cookie policy for Dewey and dewey.bear-brown.com',
}
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <section className="mb-8">
            ...
            <p>
              ...
              This Cookie Policy explains how <strong>Dewey</strong> uses cookies and similar technologies on{' '}
              <strong>dewey.bear-brown.com</strong>.
            </p>
          ...
          <section className="mb-8">
            ...
            <p>
              If you have questions about our use of cookies, please contact Dewey:
            </p>
            <ul className="list-none pl-0 mt-4 space-y-1 text-base">
              <li><strong>Email:</strong>{' '}
                <a href="mailto:bear@bearbrown.co" className="text-primary hover:underline">bear@bearbrown.co</a>
