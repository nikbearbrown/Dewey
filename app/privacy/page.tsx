...
export const metadata: Metadata = {
  title: 'Privacy Policy - Dewey',
  description: 'Privacy policy for Dewey and dewey.bear-brown.com',
}
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <section className="mb-8">
            ...
            <p>
              Welcome to <strong>dewey.bear-brown.com</strong>, operated by <strong>Dewey</strong>. We are committed to protecting your
          ...
          <section className="mb-8">
            ...
            <p className="mt-4">
              We encourage you to review the privacy policies of these third-party services. Dewey is not
          ...
          <section className="mb-8">
            ...
            <p>
              If you have questions or comments about this privacy policy, please contact Dewey:
            </p>
            <ul className="list-none pl-0 mt-4 space-y-1 text-base">
              <li><strong>Email:</strong>{' '}
                <a href="mailto:bear@bearbrown.co" className="text-primary hover:underline">bear@bearbrown.co</a>
