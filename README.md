...
# Dewey — AI-Powered Learning

A course series at Bear Brown & Company. Each course
develops a specific tier of human intelligence that AI cannot replicate.

**Live site:** https://dewey.bear-brown.com
**GitHub:** https://github.com/nikbearbrown/Dewey
...
```bash
git clone https://github.com/nikbearbrown/Dewey.git
cd Dewey
...
Dewey is open source (MIT License). See `LICENSE` for details.
