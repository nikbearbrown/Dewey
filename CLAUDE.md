...
> **Dewey — AI-Powered Learning** — a course series in Bear Brown & Company. Each course develops a specific tier of human intelligence that AI cannot replicate.

## Who this site is for
Dewey is the companion site for a course program at Bear Brown & Company. It serves as the public-facing hub for course descriptions, research blog posts, interactive tools, and developer documentation.
...
Brand voice: Academic, clear, direct. Informed by research, accessible to practitioners. No hype, no jargon for its own sake. "AI-Powered Learning."
...
## Author
**Nik Bear Brown**, Bear Brown & Company. Creator of the Dewey curriculum and this platform.
...
15. `/privacy` — Privacy Policy for Dewey
16. `/privacy/cookies` — Cookie Policy for Dewey (dedicated page)
17. `/terms-of-service` — Terms of Service for Dewey
...
- Logo: text-based "Dewey" in bold tracking-tighter
- Nav: Home (`/`) | Courses (`/courses`) | Tools (`/tools`) | Dev (`/dev`) | About (`/about`) | Blog (`/blog`)
- Social buttons (top right): GitHub (github.com/nikbearbrown/), Substack (skepticism.ai), YouTube (youtube.com/@Musinique), Spotify (open.spotify.com/artist/0hSpFCJodAYMP2cWK72zI6) — black button style
...
- **Program Info:** Dewey, Bear Brown & Company, Bear Brown & Company, bear@bearbrown.co
- **Platform:** Links to Courses, Tools, Blog, About
- **Connect:** GitHub (github.com/nikbearbrown/), Substack (skepticism.ai), Bear Brown & Co (bearbrown.co), YouTube (youtube.com/@Musinique), Spotify (open.spotify.com/artist/0hSpFCJodAYMP2cWK72zI6)
...
1. **Hero** (two-column): Left — h1 "Dewey", subtext "AI-Powered Learning", program description, "Explore Courses" + "About the Series" buttons. Right — introductory video embed.
...
- Program introduction (Dewey at Bear Brown & Company)
- Author (Nik Bear Brown, Bear Brown & Company)
- The Thesis (what AI can and can't do — the capacities AI cannot replicate)
- The Five Courses (overview of the sequence)
- Contact (email)

## Legal Pages — DONE
All three pages use the same structural template, branded for Dewey. Bear Brown & Company. Contact: bear@bearbrown.co. Educational program.
...
NEXT_PUBLIC_SITE_URL=https://dewey.bear-brown.com  # Used in sitemap generation
...
dewey.bear-brown.com is the companion site for "Dewey — AI-Powered Learning," a course series in Bear Brown & Company. It runs on Next.js with Vercel auto-deploy. The public site has no login; the admin dashboard is cookie-protected.
...
**Courses** (`/courses`) — Card grid of the courses in the Dewey sequence. Click a course to read its full description.
...
NEXT_PUBLIC_SITE_URL=https://dewey.bear-brown.com
```
...
1. ~~Rebrand Header, Footer, Home page, and About page to Dewey~~ DONE
2. ~~Build `/courses` directory page and five individual course pages~~ DONE
3. ~~Update legal pages (Privacy, Cookies, Terms) for Dewey branding~~ DONE
4. Update color palette for Dewey branding
